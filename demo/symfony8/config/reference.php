 ...
 *     }>,
 * }
 * @psalm-type NowoWalletQrConfig = array{
 *     google_wallet?: array{
 *         enabled?: bool|Param, // Enable Google Wallet save link generation (Android) // Default: false
 *         issuer_id?: scalar|Param|null, // Google Wallet issuer ID // Default: ""
 *         service_account_json?: scalar|Param|null, // Absolute path to the Google Cloud service account JSON key // Default: ""
 *         origins?: list<scalar|Param|null>,
 *     },
 *     apple_wallet?: array{
 *         enabled?: bool|Param, // Enable Apple Wallet pass download URL generation (iOS) // Default: false
 *         pass_download_url_pattern?: scalar|Param|null, // URL pattern with {pass_id} placeholder for .pkpass downloads // Default: ""
 *     },
 *     qr_code?: array{ // Deprecated: prefer nowo_qr_code (QrCodeBundle). Values are prepended onto nowo_qr_code for BC.
 *         size?: int|Param, // QR code size in pixels (forwarded to nowo_qr_code) // Default: 300
 *         margin?: int|Param, // QR code quiet zone margin in pixels (forwarded to nowo_qr_code) // Default: 10
 *         error_correction?: scalar|Param|null, // QR error correction level: low, medium, quartile, high (forwarded to nowo_qr_code) // Default: "high"
 *         url_allowlist?: list<scalar|Param|null>,
 *     },
 * }
 ...
 *     nowo_wallet_qr?: NowoWalletQrConfig,
