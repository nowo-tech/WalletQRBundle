...
git status   # review
make release-check
git -c core.hooksPath=.githooks commit -m "Release 3.0.9: FrankenPHP worker audit, QrCodeBundle ^1.4.9"
make check-no-cursor-coauthor
git tag -a v3.0.9 -m "Release 3.0.9"
...
git status   # review
make release-check
git -c core.hooksPath=.githooks commit -m "Release 3.0.1: cover qr_code prepend skip paths"
make check-no-cursor-coauthor
...
git status   # review
make release-check
git -c core.hooksPath=.githooks commit -m "Release 3.0.0: extract QR to nowo-tech/qr-code-bundle"
make check-no-cursor-coauthor
